...
const reasons = [
  ...
  },
  {
    ...
    body: "From 1 specialized hire to mid-volume operations — the same delivery standard, end to end.",
    metric: "300+",
  ...
  },
  {
    ...
    body: "Senior consultants with deep enterprise backgrounds. Not just sourcing — advising.",
    metric: "30+",
